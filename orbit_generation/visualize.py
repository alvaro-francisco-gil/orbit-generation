...
# %% auto 0
__all__ = ['visualize_static_orbits', 'export_dynamic_orbits_html', 'plot_system_features', 'plot_value_proportions']
...
def plot_system_features(df: pd.DataFrame,               # DataFrame containing the data.
                         columns: List[str]              # List of column names to plot histograms for.
                        ) -> None:
    """
    Group the DataFrame by 'system' and plot histograms for specified columns for each group.
    """
    # Group by 'system'
    ...
    for system, group in grouped:
        ...
        for i, column in enumerate(columns):
            ...
            axs[i].set_title(f'{column.capitalize()} for System: {system}')
