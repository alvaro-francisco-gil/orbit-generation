...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'orbit_generation.constants': {},
            ...
            'orbit_generation.dataset': { 'orbit_generation.dataset.get_first_period_fixed_step_dataset': ( 'dataset.html#get_first_period_fixed_step_dataset',
                                          ...
                                          'orbit_generation.dataset.substitute_values_from_df': ( 'dataset.html#substitute_values_from_df',
                                                                                                  'orbit_generation/dataset.py')},
            'orbit_generation.experiment': { 'orbit_generation.experiment.setup_new_experiment': ( 'experiment.html#setup_new_experiment',
